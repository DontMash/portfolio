...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative inline-flex w-full cursor-default items-center gap-2 py-2 pr-8 pl-2 text-sm outline-hidden transition select-none focus:bg-(--color-foreground) focus:text-(--color-background) data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      checked={checked}
      {...props}
