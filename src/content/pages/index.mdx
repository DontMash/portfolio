...
<Section max={false} background={false}>
  <Grid kind="left">
    ...
    <Frame image={{"src":"/src/assets/images/content/pages/index/profile.jpg","alt":"Sören Maschmann"}} border shadow="pop-lg" lazy={false} />
  </Grid>
...
<Section id="contact" max={false} background>
  <Grid kind="right">
    <Frame image={{"src":"/src/assets/images/content/pages/index/cover.png","alt":"A composition of shapes representing \"software\"-parts"}} border={false} shadow="none" lazy />
