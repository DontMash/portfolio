...
<Section background={false}>
  <Grid kind="left">
    <Container center={false} max={false}>
...
<Section id="contact" background>
  <Grid kind="right">
    ![](@/assets/images/pages/index/cover.png)
...
<Section id="form" background={false}>
  <Container center={false} max>
    ## Got questions?
  ...
  <Container center={false} max>
    ...
    <Accordion name="faq">
      <AccordionItem title="What do I consider a project?">
        A project is born from a vision that wants to be turned into reality. I see a shared understanding of this vision as the basis for implementation. As long as we successfully exchange ideas & priorities, I believe that every vision can be implemented. That's why I studied media informatics and have specialized in full-stack web technologies since graduating.
      </AccordionItem>
